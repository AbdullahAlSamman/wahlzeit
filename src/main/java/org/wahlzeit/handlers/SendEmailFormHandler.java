...
public class SendEmailFormHandler extends AbstractWebFormHandler {
    ...
    protected boolean isWellFormedPost(UserSession us, Map args) {
        return FoodPhotoManager.getInstance().getPhoto(us.getAsString(args, Photo.ID)) != null;
    }
    ...
    protected String doHandlePost(UserSession us, Map args) {
        String id = us.getAndSaveAsString(args, Photo.ID);
        Photo photo = FoodPhotoManager.getInstance().getPhoto(id); //Class instantiation
